...
- Lab 3.4. Browsing APIC Objects with Visore
- Lab 3.5. Exploring APIC REST API with Postman
- Lab 3.6. Manage APIC Objects with ACI Toolkit

Part 4. IaC for SDN Controllers
---
- Lab 4.1. Using Ansible with Cisco Catalyst Center
- Lab 4.2. Automating Device Deployment with Ansible
- Lab 4.3. Automating Fabric Deployment with Ansible
- Lab 4.4. Managing Cisco ACI with Terraform
- Lab 4.5. Nexus-as-Code Terraform Cisco ACI modules

Part 5. Messaging Automation
---
- Lab 5.1. GitLab messaging
- Lab 5.2. Cisco Webex API and Playing with a Bot
- Lab 5.3. Using Cisco Catalyst Center Notifications
- Lab 5.4. Running a Sample Webex Chat Bot
- Lab 5.5. Using Bot for Cisco Catalyst Center Interaction


Part 6. Developing CI/CD Pipeline Automation
---
- Lab 6.1. Setup GitLab as a CI/CD Tool
- Lab 6.2. Starting with a Sample Dummy Pipeline
- Lab 6.3. Creating an Automated Network Pipeline
- Lab 6.4. Automated Network CI/CD for Controllers
