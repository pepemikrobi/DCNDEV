...
module "APP1_EPG1" {
    ...
    domain_name = "uni/phys-phys"
    vlan_id = "1001"
    interfaces = [
        "topology/pod-1/paths-101/pathep-[eth1/X]",
        "topology/pod-1/paths-102/pathep-[eth1/X]"
    ]
...
module "APP1_EPG2" {
    ...
    vlan_id = "1002"
    interfaces = [
        "topology/pod-1/paths-101/pathep-[eth1/1X]",
        "topology/pod-1/paths-102/pathep-[eth1/2X]"
    ]
