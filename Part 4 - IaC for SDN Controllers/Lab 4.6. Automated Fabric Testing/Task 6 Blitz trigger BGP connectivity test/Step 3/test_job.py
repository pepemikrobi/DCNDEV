...
def main():
    ...
    for section in trigger_data['TriggerShutNoShutBgpNeighbor']['test_sections']:
    ...
    try:
        ...
        gRun(testbed=testbed,
             trigger_uids=['TriggerShutNoShutBgpNeighbor'],
             trigger_datafile=tmp_path,
             devices=["PODX_R1", "PODX_R1", "CORE_SW1", "CORE_SW2"],
